    ...
    <div class="img-container">
      <div>
        <img class="main-img" src="https://ifh.cc/g/Sb439x.png" alt="" />
         <img class="mobile-main-img" src="https://ifh.cc/g/TTUx5x.png" alt="" />
        <div class="bg">
          <div class="logo-box">
            <div>
          ...
          <div class="text-box">
            <span>무단투기의 실태, </span>
            <span> 어디까지 알고 있나요?</span>
            <div class="button-box">
              <div>
                <img class="pointer" src="https://ifh.cc/g/s8DAoj.png" alt="" />
              </div>
              <div class="button-content">
                <a href="/usr/content/mainTestForm">
                  <img src="https://ifh.cc/g/k73IGz.png" alt="" />
                </a>
              </div>
            </div>
          </div>
